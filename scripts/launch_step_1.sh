...
# install software
wget https://raw.githubusercontent.com/dave-mccowan/encryption-workshop/denver_2019/scripts/package.list
...
# get script files
cd ~
wget https://raw.githubusercontent.com/dave-mccowan/encryption-workshop/denver_2019/scripts/launch_step_2.sh
